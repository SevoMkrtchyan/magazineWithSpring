    ...
    <div class="container padding-bottom-3x mb-2">
        <div class="row">
            ...
            <div class="col-xl-9 col-lg-8">
                <%--<c:if test="${prodByCategoryId!=null}">--%>
                <%--<c:forEach items="${prodByCategoryId}" var="product">--%>
                <%--<div class="card mb-4">--%>
                <%--<div class="card-header"><span class="badge badge-pill badge-primary">Product</span></div>--%>
                <%--<div class="card-body">--%>
                <%--<h5><a class="navi-link" href="/sProduct">${product.name} </a></h5>--%>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="d-flex"><a class="pr-4 hidden-xs-down"
                                                       href="<c:url value="/pSingle?pId=${product.id}"/>"
                                    ...
                                    <div>
                                        <h5><a class="navi-link"
                                               href="${pageContext.request.contextPath}/pSingle?pId=${product.id}">${product.name} </a>
                                        </h5>
                                        <h6>
                        ...
                        <ul>
                            <c:forEach items="${allCategories}" var="category">
                                <li class="has-children"><a
                                        href="<c:url value="/sCategory?id=${category.id}"/>">${category.name}</a>
                                    <span>(${categoryListMap.get(category).size()})</span>
                                </li>
                            </c:forEach>
                        </ul>
                    </section>
