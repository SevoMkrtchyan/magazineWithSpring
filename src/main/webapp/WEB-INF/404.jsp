  ...
  <body>
    ...
    <%--<div class="customizer">--%>
      ...
      <%--<div class="customizer-body"><a class="btn btn-white btn-rounded btn-block mb-4 mt-0" href="../template-2/index.html">Switch To Template 2</a>--%>
        ...
        <%--<div class="customizer-color-switch"><a class="active" href="404.jsp#" data-color="default" style="background-color: #0da9ef;"></a><a href="404.jsp#" data-color="2ecc71" style="background-color: #2ecc71;"></a><a href="404.jsp#" data-color="f39c12" style="background-color: #f39c12;"></a><a href="404.jsp#" data-color="e74c3c" style="background-color: #e74c3c;"></a></div>--%>
    ...
    <div class="offcanvas-container" id="shop-categories">
      ...
      <nav class="offcanvas-menu">
        <ul class="menu">
          <li class="has-children"><span><a href="404.jsp#">Men's Shoes</a><span class="sub-menu-toggle"></span></span>
            <ul class="offcanvas-submenu">
              <li><a href="404.jsp#">Sneakers</a></li>
              <li><a href="404.jsp#">Loafers</a></li>
              <li><a href="404.jsp#">Boat Shoes</a></li>
              <li><a href="404.jsp#">Sandals</a></li>
              <li><a href="404.jsp#">View All</a></li>
            </ul>
          </li>
          <li class="has-children"><span><a href="404.jsp#">Women's Shoes</a><span class="sub-menu-toggle"></span></span>
            <ul class="offcanvas-submenu">
              <li><a href="404.jsp#">Sandals</a></li>
              <li><a href="404.jsp#">Flats</a></li>
              <li><a href="404.jsp#">Sneakers</a></li>
              <li><a href="404.jsp#">Heels</a></li>
              <li><a href="404.jsp#">View All</a></li>
            </ul>
          </li>
          <li class="has-children"><span><a href="404.jsp#">Men's Clothing</a><span class="sub-menu-toggle"></span></span>
            <ul class="offcanvas-submenu">
              <li><a href="404.jsp#">Shirts &amp; Tops</a></li>
              <li><a href="404.jsp#">Pants</a></li>
              <li><a href="404.jsp#">Jackets</a></li>
              <li><a href="404.jsp#">View All</a></li>
            </ul>
          </li>
          <li class="has-children"><span><a href="404.jsp#">Women's Clothing</a><span class="sub-menu-toggle"></span></span>
            <ul class="offcanvas-submenu">
              <li><a href="404.jsp#">Dresses</a></li>
              <li><a href="404.jsp#">Shirts &amp; Tops</a></li>
              <li><a href="404.jsp#">Shorts</a></li>
              <li><a href="404.jsp#">Swimwear</a></li>
              <li><a href="404.jsp#">View All</a></li>
            </ul>
          </li>
          <li class="has-children"><span><a href="404.jsp#">Kid's Shoes</a><span class="sub-menu-toggle"></span></span>
            <ul class="offcanvas-submenu">
              <li><a href="404.jsp#">Boots</a></li>
              <li><a href="404.jsp#">Sandals</a></li>
              <li><a href="404.jsp#">Crib Shoes</a></li>
              <li><a href="404.jsp#">Loafers</a></li>
              <li><a href="404.jsp#">View All</a></li>
            </ul>
          </li>
          <li class="has-children"><span><a href="404.jsp#">Bags</a><span class="sub-menu-toggle"></span></span>
            <ul class="offcanvas-submenu">
              <li><a href="404.jsp#">Handbags</a></li>
              <li><a href="404.jsp#">Backpacks</a></li>
              <li><a href="404.jsp#">Luggage</a></li>
              <li><a href="404.jsp#">Wallets</a></li>
              <li><a href="404.jsp#">View All</a></li>
            </ul>
          </li>
          <li class="has-children"><span><a href="404.jsp#">Accessories</a><span class="sub-menu-toggle"></span></span>
            <ul class="offcanvas-submenu">
              <li><a href="404.jsp#">Sunglasses</a></li>
              <li><a href="404.jsp#">Hats</a></li>
              <li><a href="404.jsp#">Watches</a></li>
              <li><a href="404.jsp#">Jewelry</a></li>
              <li><a href="404.jsp#">Belts</a></li>
              <li><a href="404.jsp#">View All</a></li>
            </ul>
          </li>
        </ul>
    ...
    <div class="offcanvas-container" id="mobile-menu"><a class="account-link" href="account-orders.html">
      ...
      <nav class="offcanvas-menu">
        <ul class="menu">
          ...
          <li class="has-children"><span><a href="404.jsp#">Categories</a><span class="sub-menu-toggle"></span></span>
            <ul class="offcanvas-submenu">
              <li class="has-children"><span><a href="404.jsp#">Men's Shoes</a><span class="sub-menu-toggle"></span></span>
                <ul class="offcanvas-submenu">
                  <li><a href="404.jsp#">Sneakers</a></li>
          ...
          <li class="has-children"><span><a href="account-orders.html"><span>Account</span></a><span class="sub-menu-toggle"></span></span>
            <ul class="offcanvas-submenu">
                ...
                <li><a href="http://themes.rokaux.com/unishop/v2.2/template-1/account-open-ticket.html">Open Ticket</a></li>
          ...
          <li class="has-children active"><span><a href="404.jsp#"><span>Pages</span></a><span class="sub-menu-toggle"></span></span>
            <ul class="offcanvas-submenu">
                <li><a href="about.html">About Us</a></li>
                <li><a href="http://themes.rokaux.com/unishop/v2.2/template-1/mobile-app.html">Unishop Mobile App</a></li>
    ...
    <!-- Topbar-->
    <%--<div class="topbar">--%>
      <%--<div class="topbar-column"><a class="hidden-md-down" href="mailto:support@unishop.com"><i class="icon-mail"></i>&nbsp; support@unishop.com</a><a class="hidden-md-down" href="tel:00331697720"><i class="icon-bell"></i>&nbsp; 00 33 169 7720</a><a class="social-button sb-facebook shape-none sb-dark" href="404.jsp#" target="_blank"><i class="socicon-facebook"></i></a><a class="social-button sb-twitter shape-none sb-dark" href="404.jsp#" target="_blank"><i class="socicon-twitter"></i></a><a class="social-button sb-instagram shape-none sb-dark" href="404.jsp#" target="_blank"><i class="socicon-instagram"></i></a><a class="social-button sb-pinterest shape-none sb-dark" href="404.jsp#" target="_blank"><i class="socicon-pinterest"></i></a>--%>
      <%--</div>--%>
      <%--<div class="topbar-column"><a class="hidden-md-down" href="404.jsp#"><i class="icon-download"></i>&nbsp; Get mobile app</a>--%>
        <%--<div class="lang-currency-switcher-wrap">--%>
          ...
          <%--<div class="dropdown-menu">--%>
            <%--<div class="currency-select">--%>
              ...
              <%--</select>--%>
            <%--</div><a class="dropdown-item" href="404.jsp#"><img src="img/flags/FR.png" alt="Français">Français</a><a class="dropdown-item" href="404.jsp#"><img src="img/flags/DE.png" alt="Deutsch">Deutsch</a><a class="dropdown-item" href="404.jsp#"><img src="img/flags/IT.png" alt="Italiano">Italiano</a>--%>
          <%--</div>--%>
        <%--</div>--%>
      <%--</div>--%>
    <%--</div>--%>
    ...
    <%--<header class="navbar navbar-sticky">--%>
      ...
      <%--<div class="site-branding">--%>
        <%--<div class="inner">--%>
          <%--<!-- Off-Canvas Toggle (#shop-categories)--><a class="offcanvas-toggle cats-toggle" href="404.jsp#shop-categories" data-toggle="offcanvas"></a>--%>
          <%--<!-- Off-Canvas Toggle (#mobile-menu)--><a class="offcanvas-toggle menu-toggle" href="404.jsp#mobile-menu" data-toggle="offcanvas"></a>--%>
      ...
      <%--<nav class="site-menu">--%>
        <%--<ul>--%>
          ...
          <%--<li><a href="shop-grid-ls.html"><span>Shop</span></a>--%>
            ...
            <%--</ul>--%>
          <%--</li>--%>
          <%--<li class="has-megamenu"><a href="404.jsp#"><span>Mega Menu</span></a>--%>
            <%--<ul class="mega-menu">--%>
              <%--<li><span class="mega-menu-title">Top Categories</span>--%>
                <%--<ul class="sub-menu">--%>
                  <%--<li><a href="404.jsp#">Men's Shoes</a></li>--%>
                  <%--<li><a href="404.jsp#">Women's Shoes</a></li>--%>
                  <%--<li><a href="404.jsp#">Shirts and Tops</a></li>--%>
                  <%--<li><a href="404.jsp#">Swimwear</a></li>--%>
                  <%--<li><a href="404.jsp#">Shorts and Pants</a></li>--%>
                  <%--<li><a href="404.jsp#">Accessories</a></li>--%>
                <%--</ul>--%>
              <%--</li>--%>
              <%--<li><span class="mega-menu-title">Specialty Shops</span>--%>
                <%--<ul class="sub-menu">--%>
                  <%--<li><a href="404.jsp#">Junior's Shop</a></li>--%>
                  <%--<li><a href="404.jsp#">Swim Shop</a></li>--%>
                  <%--<li><a href="404.jsp#">Athletic Shop</a></li>--%>
                  <%--<li><a href="404.jsp#">Outdoor Shop</a></li>--%>
                  <%--<li><a href="404.jsp#">Luxury Shop</a></li>--%>
                  <%--<li><a href="404.jsp#">Accessories Shop</a></li>--%>
                <%--</ul>--%>
              <%--</li>--%>
              <%--<li>--%>
                <%--<section class="promo-box" style="background-image: url(img/banners/02.jpg);"><span class="overlay-dark" style="opacity: .4;"></span>--%>
                  <%--<div class="promo-box-content text-center padding-top-2x padding-bottom-2x">--%>
                    ...
                    <%--<h3 class="text-bold text-light text-shadow">Sunglasses</h3><a class="btn btn-sm btn-primary" href="404.jsp#">Shop Now</a>--%>
                  <%--</div>--%>
                <%--</section>--%>
              <%--</li>--%>
              <%--<li>--%>
                <%--<section class="promo-box" style="background-image: url(img/banners/03.jpg);">--%>
                  ...
                  <%--<div class="promo-box-content text-center padding-top-2x padding-bottom-2x">--%>
                    ...
                    <%--<h4 class="text-light text-thin text-shadow">save up to 50%!</h4><a class="btn btn-sm btn-primary" href="404.jsp#">Learn More</a>--%>
                  <%--</div>--%>
                <%--</section>--%>
              <%--</li>--%>
            <%--</ul>--%>
          ...
          <%--<li><a href="blog-rs.html"><span>Blog</span></a>--%>
            ...
            <%--</ul>--%>
          <%--</li>--%>
          <%--<li class="active"><a href="404.jsp#"><span>Pages</span></a>--%>
            <%--<ul class="sub-menu">--%>
                <%--<li><a href="about.html">About Us</a></li>--%>
                <%--<li><a href="contacts.html">Contacts</a></li>--%>
                <%--<li><a href="faq.html">Help / FAQ</a></li>--%>
                <%--<li><a href="order-tracking.html">Order Tracking</a></li>--%>
                <%--<li><a href="search-results.html">Search Results</a></li>--%>
                <%--<li class="active"><a href="404.jsp">404 Not Found</a></li>--%>
                <%--<li><a href="coming-soon.html">Coming Soon</a></li>--%>
              <%--<li><a class="text-danger" href="docs/dev-setup.html">Documentation</a></li>--%>
            <%--</ul>--%>
          <%--</li>--%>
          ...
          <%--<div class="tools">--%>
            ...
            <%--<div class="account"><a href="account-orders.html"></a><i class="icon-head"></i>--%>
              <%--<ul class="toolbar-dropdown">--%>
                ...
                <%--<li><a href="404.jsp#"> <i class="icon-unlock"></i>Logout</a></li>--%>
              <%--</ul>--%>
            <%--</div>--%>
          ...
          <div class="row">
            <div class="col-lg-3 col-md-6">
              ...
              <section class="widget widget-light-skin">
                ...
                <p><a class="navi-link-light" href="404.jsp#">support@unishop.com</a></p><a class="social-button shape-circle sb-facebook sb-light-skin" href="404.jsp#"><i class="socicon-facebook"></i></a><a class="social-button shape-circle sb-twitter sb-light-skin" href="404.jsp#"><i class="socicon-twitter"></i></a><a class="social-button shape-circle sb-instagram sb-light-skin" href="404.jsp#"><i class="socicon-instagram"></i></a><a class="social-button shape-circle sb-google-plus sb-light-skin" href="404.jsp#"><i class="socicon-googleplus"></i></a>
              </section>
            </div>
            <div class="col-lg-3 col-md-6">
              <!-- Mobile App Buttons-->
              <section class="widget widget-light-skin">
                <h3 class="widget-title">Our Mobile App</h3><a class="market-button apple-button mb-light-skin" href="404.jsp#"><span class="mb-subtitle">Download on the</span><span class="mb-title">App Store</span></a><a class="market-button google-button mb-light-skin" href="404.jsp#"><span class="mb-subtitle">Download on the</span><span class="mb-title">Google Play</span></a><a class="market-button windows-button mb-light-skin" href="404.jsp#"><span class="mb-subtitle">Download on the</span><span class="mb-title">Windows Store</span></a>
              </section>
            </div>
            <div class="col-lg-3 col-md-6">
              <!-- About Us-->
              <section class="widget widget-links widget-light-skin">
                ...
                <ul>
                  <li><a href="404.jsp#">Careers</a></li>
                  <li><a href="404.jsp#">About Unishop</a></li>
                  <li><a href="404.jsp#">Our Story</a></li>
                  <li><a href="404.jsp#">Services</a></li>
                  <li><a href="404.jsp#">Our Blog</a></li>
                </ul>
              </section>
            </div>
            <div class="col-lg-3 col-md-6">
              ...
              <section class="widget widget-links widget-light-skin">
                ...
                <ul>
                  <li><a href="404.jsp#">Your Account</a></li>
                  <li><a href="404.jsp#">Shipping Rates & Policies</a></li>
                  <li><a href="404.jsp#">Refunds & Replacements</a></li>
                  <li><a href="404.jsp#">Taxes</a></li>
                  <li><a href="404.jsp#">Delivery Info</a></li>
                  <li><a href="404.jsp#">Affiliate Program</a></li>
                </ul>
              </section>
            </div>
          </div>
    ...
    <!-- Back To Top Button--><a class="scroll-to-top-btn" href="404.jsp#"><i class="icon-arrow-up"></i></a>
    <!-- Backdrop-->
