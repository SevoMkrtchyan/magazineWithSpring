    ...
    <div class="container padding-bottom-3x mb-2">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                ...
                <form class="card mt-4" action="/rec" method="post">
                    <div class="card-body">
                        <div class="form-group">
                            <c:if test="${message==null}">
                                <label for="email-for-pass">Hello ${user.name} Please Enter your recovery Code</label>
                            </c:if>
                            <c:if test="${message!=null}">
                                <label for="email-for-pass">${message} Please Enter Valid Code</label>
                            </c:if>
                            <input class="form-control" type="text" id="email-for-pass" name="code" required>
