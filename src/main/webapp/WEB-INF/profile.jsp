...
<%--<div class="customizer">--%>
    ...
    <%--<div class="customizer-body"><a class="btn btn-white btn-rounded btn-block mb-4 mt-0"--%>
        ...
        <%--<div class="customizer-color-switch"><a class="active" href="account-profile.html#" data-color="default"--%>
                                                <%--style="background-color: #0da9ef;"></a><a href="account-profile.html#"--%>
                                                                                          <%--data-color="2ecc71"--%>
                                                                                          <%--style="background-color: #2ecc71;"></a><a--%>
                <%--href="account-profile.html#" data-color="f39c12" style="background-color: #f39c12;"></a><a--%>
                <%--href="account-profile.html#" data-color="e74c3c" style="background-color: #e74c3c;"></a></div>--%>
...
<div class="offcanvas-container" id="shop-categories">
    ...
    <nav class="offcanvas-menu">
        <ul class="menu">
            <li class="has-children"><span><a href="account-profile.html#">Men's Shoes</a><span
                    class="sub-menu-toggle"></span></span>
                <ul class="offcanvas-submenu">
                    <li><a href="account-profile.html#">Sneakers</a></li>
                    <li><a href="account-profile.html#">Loafers</a></li>
                    <li><a href="account-profile.html#">Boat Shoes</a></li>
                    <li><a href="account-profile.html#">Sandals</a></li>
                    <li><a href="account-profile.html#">View All</a></li>
                </ul>
            </li>
            <li class="has-children"><span><a href="account-profile.html#">Women's Shoes</a><span
                    class="sub-menu-toggle"></span></span>
                <ul class="offcanvas-submenu">
                    <li><a href="account-profile.html#">Sandals</a></li>
                    <li><a href="account-profile.html#">Flats</a></li>
                    <li><a href="account-profile.html#">Sneakers</a></li>
                    <li><a href="account-profile.html#">Heels</a></li>
                    <li><a href="account-profile.html#">View All</a></li>
                </ul>
            </li>
            <li class="has-children"><span><a href="account-profile.html#">Men's Clothing</a><span
                    class="sub-menu-toggle"></span></span>
                <ul class="offcanvas-submenu">
                    <li><a href="account-profile.html#">Shirts &amp; Tops</a></li>
                    <li><a href="account-profile.html#">Pants</a></li>
                    <li><a href="account-profile.html#">Jackets</a></li>
                    <li><a href="account-profile.html#">View All</a></li>
                </ul>
            </li>
            <li class="has-children"><span><a href="account-profile.html#">Women's Clothing</a><span
                    class="sub-menu-toggle"></span></span>
                <ul class="offcanvas-submenu">
                    <li><a href="account-profile.html#">Dresses</a></li>
                    <li><a href="account-profile.html#">Shirts &amp; Tops</a></li>
                    <li><a href="account-profile.html#">Shorts</a></li>
                    <li><a href="account-profile.html#">Swimwear</a></li>
                    <li><a href="account-profile.html#">View All</a></li>
                </ul>
            </li>
            <li class="has-children"><span><a href="account-profile.html#">Kid's Shoes</a><span
                    class="sub-menu-toggle"></span></span>
                <ul class="offcanvas-submenu">
                    <li><a href="account-profile.html#">Boots</a></li>
                    <li><a href="account-profile.html#">Sandals</a></li>
                    <li><a href="account-profile.html#">Crib Shoes</a></li>
                    <li><a href="account-profile.html#">Loafers</a></li>
                    <li><a href="account-profile.html#">View All</a></li>
                </ul>
            </li>
            <li class="has-children"><span><a href="account-profile.html#">Bags</a><span class="sub-menu-toggle"></span></span>
                <ul class="offcanvas-submenu">
                    <li><a href="account-profile.html#">Handbags</a></li>
                    <li><a href="account-profile.html#">Backpacks</a></li>
                    <li><a href="account-profile.html#">Luggage</a></li>
                    <li><a href="account-profile.html#">Wallets</a></li>
                    <li><a href="account-profile.html#">View All</a></li>
                </ul>
            </li>
            <li class="has-children"><span><a href="account-profile.html#">Accessories</a><span
                    class="sub-menu-toggle"></span></span>
                <ul class="offcanvas-submenu">
                    <li><a href="account-profile.html#">Sunglasses</a></li>
                    <li><a href="account-profile.html#">Hats</a></li>
                    <li><a href="account-profile.html#">Watches</a></li>
                    <li><a href="account-profile.html#">Jewelry</a></li>
                    <li><a href="account-profile.html#">Belts</a></li>
                    <li><a href="account-profile.html#">View All</a></li>
                </ul>
            </li>
        </ul>
...
<div class="offcanvas-container" id="mobile-menu"><a class="account-link" href="account-orders.html">
    <div class="user-ava"><img src="image/fileName=${user.picUrl}" alt="Daniel Adams">
    </div>
    <div class="user-info">
        <h6 class="user-name">${user.name} &nbsp; ${user.surname}</h6><span
            class="text-sm text-white opacity-60"></span>
    </div>
</a>
    <nav class="offcanvas-menu">
        <ul class="menu">
            ...
            <li class="has-children"><span><a href="account-profile.html#">Categories</a><span
                    class="sub-menu-toggle"></span></span>
                <ul class="offcanvas-submenu">
                    <li class="has-children"><span><a href="account-profile.html#">Men's Shoes</a><span
                            class="sub-menu-toggle"></span></span>
                    ...
                    <li class="has-children"><span><a href="account-profile.html#">Bags</a><span
                            class="sub-menu-toggle"></span></span>
                        <ul class="offcanvas-submenu">
                            <li><a href="account-profile.html#">Handbags</a></li>
                            <li><a href="account-profile.html#">Backpacks</a></li>
            ...
            <li class="has-children"><span><a href="account-profile.html#"><span>Pages</span></a><span
                    class="sub-menu-toggle"></span></span>
                <ul class="offcanvas-submenu">
...
<%--<div class="topbar">--%>
    <%--<div class="topbar-column"><a class="hidden-md-down" href="mailto:support@unishop.com"><i class="icon-mail"></i>&nbsp;--%>
        ...
        <%--169 7720</a><a class="social-button sb-facebook shape-none sb-dark" href="account-profile.html#"--%>
                       <%--target="_blank"><i class="socicon-facebook"></i></a><a--%>
            <%--class="social-button sb-twitter shape-none sb-dark" href="account-profile.html#" target="_blank"><i--%>
            <%--class="socicon-twitter"></i></a><a class="social-button sb-instagram shape-none sb-dark"--%>
                                               <%--href="account-profile.html#" target="_blank"><i--%>
            <%--class="socicon-instagram"></i></a><a class="social-button sb-pinterest shape-none sb-dark"--%>
                                                 <%--href="account-profile.html#" target="_blank"><i--%>
            <%--class="socicon-pinterest"></i></a>--%>
    <%--</div>--%>
    <%--<div class="topbar-column"><a class="hidden-md-down" href="account-profile.html#"><i class="icon-download"></i>&nbsp;--%>
        <%--Get mobile app</a>--%>
        <%--<div class="lang-currency-switcher-wrap">--%>
            ...
            <%--<div class="dropdown-menu">--%>
                <%--<div class="currency-select">--%>
                    ...
                    <%--</select>--%>
                <%--</div>--%>
                <%--<a class="dropdown-item" href="account-profile.html#"><img src="img/flags/FR.png" alt="Français">Français</a><a--%>
                    <%--class="dropdown-item" href="account-profile.html#"><img src="img/flags/DE.png" alt="Deutsch">Deutsch</a><a--%>
                    <%--class="dropdown-item" href="account-profile.html#"><img src="img/flags/IT.png" alt="Italiano">Italiano</a>--%>
            <%--</div>--%>
        <%--</div>--%>
    <%--</div>--%>
<%--</div>--%>
    ...
    <%--<div class="site-branding">--%>
        <%--<div class="inner">--%>
            <%--<!-- Off-Canvas Toggle (#shop-categories)--><a class="offcanvas-toggle cats-toggle"--%>
                                                           <%--href="account-profile.html#shop-categories"--%>
                                                           <%--data-toggle="offcanvas"></a>--%>
            <%--<!-- Off-Canvas Toggle (#mobile-menu)--><a class="offcanvas-toggle menu-toggle"--%>
                                                       <%--href="account-profile.html#mobile-menu"--%>
                                                       <%--data-toggle="offcanvas"></a>--%>
    ...
    <%--<nav class="site-menu">--%>
        <%--<ul>--%>
            ...
            <%--<li><a href="shop-grid-ls.html"><span>Shop</span></a>--%>
                ...
                <%--</ul>--%>
            <%--</li>--%>
            <%--<li class="has-megamenu"><a href="account-profile.html#"><span>Mega Menu</span></a>--%>
                <%--<ul class="mega-menu">--%>
                    <%--<li><span class="mega-menu-title">Top Categories</span>--%>
                        <%--<ul class="sub-menu">--%>
                            <%--<li><a href="account-profile.html#">Men's Shoes</a></li>--%>
                            <%--<li><a href="account-profile.html#">Women's Shoes</a></li>--%>
                            <%--<li><a href="account-profile.html#">Shirts and Tops</a></li>--%>
                            <%--<li><a href="account-profile.html#">Swimwear</a></li>--%>
                            <%--<li><a href="account-profile.html#">Shorts and Pants</a></li>--%>
                            <%--<li><a href="account-profile.html#">Accessories</a></li>--%>
                        <%--</ul>--%>
                    <%--</li>--%>
                    <%--<li><span class="mega-menu-title">Specialty Shops</span>--%>
                        <%--<ul class="sub-menu">--%>
                            <%--<li><a href="account-profile.html#">Junior's Shop</a></li>--%>
                            <%--<li><a href="account-profile.html#">Swim Shop</a></li>--%>
                            <%--<li><a href="account-profile.html#">Athletic Shop</a></li>--%>
                            <%--<li><a href="account-profile.html#">Outdoor Shop</a></li>--%>
                            <%--<li><a href="account-profile.html#">Luxury Shop</a></li>--%>
                            <%--<li><a href="account-profile.html#">Accessories Shop</a></li>--%>
                        <%--</ul>--%>
                    <%--</li>--%>
                    <%--<li>--%>
                        <%--<section class="promo-box" style="background-image: url(img/banners/02.jpg);"><span--%>
                            ...
                            <%--<div class="promo-box-content text-center padding-top-2x padding-bottom-2x">--%>
                                ...
                                <%--<h3 class="text-bold text-light text-shadow">Sunglasses</h3><a--%>
                                    <%--class="btn btn-sm btn-primary" href="account-profile.html#">Shop Now</a>--%>
                            <%--</div>--%>
                        <%--</section>--%>
                    <%--</li>--%>
                    <%--<li>--%>
                        <%--<section class="promo-box" style="background-image: url(img/banners/03.jpg);">--%>
                            ...
                            <%--<div class="promo-box-content text-center padding-top-2x padding-bottom-2x">--%>
                                ...
                                <%--<h4 class="text-light text-thin text-shadow">save up to 50%!</h4><a--%>
                                    <%--class="btn btn-sm btn-primary" href="account-profile.html#">Learn More</a>--%>
                            <%--</div>--%>
                        <%--</section>--%>
                    <%--</li>--%>
                <%--</ul>--%>
            ...
            <%--<li><a href="blog-rs.html"><span>Blog</span></a>--%>
                ...
                <%--</ul>--%>
            <%--</li>--%>
            <%--<li><a href="account-profile.html#"><span>Pages</span></a>--%>
                <%--<ul class="sub-menu">--%>
                    <%--<li><a href="about.html">About Us</a></li>--%>
                    <%--<li><a href="contacts.html">Contacts</a></li>--%>
                    <%--<li><a href="faq.html">Help / FAQ</a></li>--%>
                ...
                <%--<div class="account"><a href="account-orders.html"></a><i class="icon-head"></i>--%>
                    <%--<ul class="toolbar-dropdown">--%>
                        <%--<li class="sub-menu-user">--%>
                            ...
                            <%--<div class="user-info">--%>
                                <%--<h6 class="user-name">${user.name}&nbsp;${user.surname}</h6><span--%>
                                    <%--class="text-xs text-muted">290 Reward points</span>--%>
                            <%--</div>--%>
                        <%--</li>--%>
                        ...
                        <%--<li><a href="account-profile.html#"> <i class="icon-unlock"></i>Logout</a></li>--%>
                    <%--</ul>--%>
                <%--</div>--%>
            ...
            <li><a href="#"><span>Account</span></a>
                <ul class="sub-menu">
                    ...
                    <c:if test="${user!=null}">
                        ...
                        <li><a href="/prof?userId=${user.id}">Profile Page</a></li>
        ...
        <div class="row">
            <div class="col-lg-4">
                <aside class="user-info-wrapper">
                    <div class="user-cover" style="background-image: url(img/account/user-cover-img.jpg);">
                        <div class="info-label" data-toggle="tooltip"
                             title="You currently have 290 Reward Points to spend"><i class="icon-medal"></i>
                        </div>
                    </div>
                    <div class="user-info">
                        <div class="user-avatar"><a class="edit-avatar" href="account-profile.html#"></a><img
                                src="image?fileName=${user.picUrl}" alt="User"></div>
                        <div class="user-data">
                            <h4>${user.name}&nbsp;${user.surname}</h4><span></span>
                        </div>
                    </div>
                </aside>
                <nav class="list-group"><a class="list-group-item with-badge" href="account-orders.html"><i
                        ...
                        class="list-group-item active" href="account-profile.html"><i
                        class="icon-head"></i>Profile</a><a class="list-group-item" href="account-address.html"><i
                        class="icon-map"></i>Addresses</a><a class="list-group-item with-badge"
                                                             href="account-wishlist.html"><i class="icon-heart"></i>Wishlist<span
                        class="badge badge-primary badge-pill">3</span></a><a class="list-group-item with-badge"
                      h e                                                        href="account-tickets.html"><i
                        class="icon-tag"></i>My Tickets<span class="badge badge-primary badge-pill">4</span></a></nav>
            </div>
            <div class="col-lg-8">
                <div class="padding-top-2x mt-2 hidden-lg-up"></div>
                <form class="row" action="/sUSData" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="account-ln"  name="surname">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="file" id="account-phone" name="userImg">
                        </div>
                    </div>
                    <div class="col-12">
                        <hr class="mt-2 mb-3">
                        <div class="d-flex flex-wrap justify-content-between align-items-center">
                            <input class="btn btn-primary margin-right-none" type="submit" data-toast
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    ...
                    <section class="widget widget-light-skin">
                        ...
                        <p><a class="navi-link-light" href="account-profile.html#">support@unishop.com</a></p><a
                            class="social-button shape-circle sb-facebook sb-light-skin" href="account-profile.html#"><i
                            class="socicon-facebook"></i></a><a
                            class="social-button shape-circle sb-twitter sb-light-skin" href="account-profile.html#"><i
                            class="socicon-twitter"></i></a><a
                            class="social-button shape-circle sb-instagram sb-light-skin"
                            href="account-profile.html#"><i class="socicon-instagram"></i></a><a
                            class="social-button shape-circle sb-google-plus sb-light-skin"
                            href="account-profile.html#"><i class="socicon-googleplus"></i></a>
                    </section>
                </div>
                <div class="col-lg-3 col-md-6">
                    <!-- Mobile App Buttons-->
                    <section class="widget widget-light-skin">
                        <h3 class="widget-title">Our Mobile App</h3><a class="market-button apple-button mb-light-skin"
                                                                       href="account-profile.html#"><span
                            class="mb-subtitle">Download on the</span><span class="mb-title">App Store</span></a><a
                            class="market-button google-button mb-light-skin" href="account-profile.html#"><span
                            class="mb-subtitle">Download on the</span><span class="mb-title">Google Play</span></a><a
                            class="market-button windows-button mb-light-skin" href="account-profile.html#"><span
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <section class="widget widget-links widget-light-skin">
                        ...
                        <ul>
                            <li><a href="account-profile.html#">Careers</a></li>
                            <li><a href="account-profile.html#">About Unishop</a></li>
                            <li><a href="account-profile.html#">Our Story</a></li>
                            <li><a href="account-profile.html#">Services</a></li>
                            <li><a href="account-profile.html#">Our Blog</a></li>
                        </ul>
                    </section>
                </div>
                <div class="col-lg-3 col-md-6">
                    ...
                    <section class="widget widget-links widget-light-skin">
                        ...
                        <ul>
                            <li><a href="account-profile.html#">Your Account</a></li>
                            <li><a href="account-profile.html#">Shipping Rates & Policies</a></li>
                            <li><a href="account-profile.html#">Refunds & Replacements</a></li>
                            <li><a href="account-profile.html#">Taxes</a></li>
                            <li><a href="account-profile.html#">Delivery Info</a></li>
                            <li><a href="account-profile.html#">Affiliate Program</a></li>
                        </ul>
                    </section>
                </div>
            </div>
...
<!-- Back To Top Button--><a class="scroll-to-top-btn" href="account-profile.html#"><i class="icon-arrow-up"></i></a>
<!-- Backdrop-->
