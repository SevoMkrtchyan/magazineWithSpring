...
<%--<div class="customizer">--%>
    ...
    <%--<div class="customizer-body"><a class="btn btn-white btn-rounded btn-block mb-4 mt-0"--%>
        ...
        <%--<div class="customizer-color-switch"><a class="active" href="account-password-recovery.html#"--%>
                                                <%--data-color="default" style="background-color: #0da9ef;"></a><a--%>
                <%--href="account-password-recovery.html#" data-color="2ecc71" style="background-color: #2ecc71;"></a><a--%>
                <%--href="account-password-recovery.html#" data-color="f39c12" style="background-color: #f39c12;"></a><a--%>
                <%--href="account-password-recovery.html#" data-color="e74c3c" style="background-color: #e74c3c;"></a></div>--%>
...
<div class="offcanvas-container" id="shop-categories">
    ...
    <nav class="offcanvas-menu">
        <ul class="menu">
            <li class="has-children"><span><a href="account-password-recovery.html#">Men's Shoes</a><span
                    class="sub-menu-toggle"></span></span>
                <ul class="offcanvas-submenu">
                    <li><a href="account-password-recovery.html#">Sneakers</a></li>
                    <li><a href="account-password-recovery.html#">Loafers</a></li>
                    <li><a href="account-password-recovery.html#">Boat Shoes</a></li>
                    <li><a href="account-password-recovery.html#">Sandals</a></li>
                    <li><a href="account-password-recovery.html#">View All</a></li>
                </ul>
            </li>
            <li class="has-children"><span><a href="account-password-recovery.html#">Women's Shoes</a><span
                    class="sub-menu-toggle"></span></span>
                <ul class="offcanvas-submenu">
                    <li><a href="account-password-recovery.html#">Sandals</a></li>
                    <li><a href="account-password-recovery.html#">Flats</a></li>
                    <li><a href="account-password-recovery.html#">Sneakers</a></li>
                    <li><a href="account-password-recovery.html#">Heels</a></li>
                    <li><a href="account-password-recovery.html#">View All</a></li>
                </ul>
            </li>
            <li class="has-children"><span><a href="account-password-recovery.html#">Men's Clothing</a><span
                    class="sub-menu-toggle"></span></span>
                <ul class="offcanvas-submenu">
                    <li><a href="account-password-recovery.html#">Shirts &amp; Tops</a></li>
                    <li><a href="account-password-recovery.html#">Pants</a></li>
                    <li><a href="account-password-recovery.html#">Jackets</a></li>
                    <li><a href="account-password-recovery.html#">View All</a></li>
                </ul>
            </li>
            <li class="has-children"><span><a href="account-password-recovery.html#">Women's Clothing</a><span
                    class="sub-menu-toggle"></span></span>
                <ul class="offcanvas-submenu">
                    <li><a href="account-password-recovery.html#">Dresses</a></li>
                    <li><a href="account-password-recovery.html#">Shirts &amp; Tops</a></li>
                    <li><a href="account-password-recovery.html#">Shorts</a></li>
                    <li><a href="account-password-recovery.html#">Swimwear</a></li>
                    <li><a href="account-password-recovery.html#">View All</a></li>
                </ul>
            </li>
            <li class="has-children"><span><a href="account-password-recovery.html#">Kid's Shoes</a><span
                    class="sub-menu-toggle"></span></span>
                <ul class="offcanvas-submenu">
                    <li><a href="account-password-recovery.html#">Boots</a></li>
                    <li><a href="account-password-recovery.html#">Sandals</a></li>
                    <li><a href="account-password-recovery.html#">Crib Shoes</a></li>
                    <li><a href="account-password-recovery.html#">Loafers</a></li>
                    <li><a href="account-password-recovery.html#">View All</a></li>
                </ul>
            </li>
            <li class="has-children"><span><a href="account-password-recovery.html#">Bags</a><span
                    class="sub-menu-toggle"></span></span>
                <ul class="offcanvas-submenu">
                    <li><a href="account-password-recovery.html#">Handbags</a></li>
                    <li><a href="account-password-recovery.html#">Backpacks</a></li>
                    <li><a href="account-password-recovery.html#">Luggage</a></li>
                    <li><a href="account-password-recovery.html#">Wallets</a></li>
                    <li><a href="account-password-recovery.html#">View All</a></li>
                </ul>
            </li>
            <li class="has-children"><span><a href="account-password-recovery.html#">Accessories</a><span
                    class="sub-menu-toggle"></span></span>
                <ul class="offcanvas-submenu">
                    <li><a href="account-password-recovery.html#">Sunglasses</a></li>
                    <li><a href="account-password-recovery.html#">Hats</a></li>
                    <li><a href="account-password-recovery.html#">Watches</a></li>
                    <li><a href="account-password-recovery.html#">Jewelry</a></li>
                    <li><a href="account-password-recovery.html#">Belts</a></li>
                    <li><a href="account-password-recovery.html#">View All</a></li>
                </ul>
            </li>
        </ul>
...
<div class="offcanvas-container" id="mobile-menu"><a class="account-link" href="account-orders.html">
    ...
    <nav class="offcanvas-menu">
        <ul class="menu">
            ...
            <li class="has-children"><span><a href="account-password-recovery.html#">Categories</a><span
                    class="sub-menu-toggle"></span></span>
                <ul class="offcanvas-submenu">
                    <li class="has-children"><span><a href="account-password-recovery.html#">Men's Shoes</a><span
                            class="sub-menu-toggle"></span></span>
            ...
            <li class="has-children"><span><a href="account-password-recovery.html#"><span>Pages</span></a><span
                    class="sub-menu-toggle"></span></span>
                <ul class="offcanvas-submenu">
...
<%--<div class="topbar">--%>
    <%--<div class="topbar-column"><a class="hidden-md-down" href="mailto:support@unishop.com"><i class="icon-mail"></i>&nbsp;--%>
        ...
        <%--169 7720</a><a class="social-button sb-facebook shape-none sb-dark" href="account-password-recovery.html#"--%>
                       <%--target="_blank"><i class="socicon-facebook"></i></a><a--%>
            <%--class="social-button sb-twitter shape-none sb-dark" href="account-password-recovery.html#"--%>
            ...
            <%--class="socicon-instagram"></i></a><a class="social-button sb-pinterest shape-none sb-dark"--%>
                                                 <%--href="account-password-recovery.html#" target="_blank"><i--%>
            <%--class="socicon-pinterest"></i></a>--%>
    <%--</div>--%>
    <%--<div class="topbar-column"><a class="hidden-md-down" href="account-password-recovery.html#"><i--%>
            <%--class="icon-download"></i>&nbsp; Get mobile app</a>--%>
        <%--<div class="lang-currency-switcher-wrap">--%>
            ...
            <%--<div class="dropdown-menu">--%>
                <%--<div class="currency-select">--%>
                    ...
                    <%--</select>--%>
                <%--</div>--%>
                <%--<a class="dropdown-item" href="account-password-recovery.html#"><img src="img/flags/FR.png"--%>
                                                                                     <%--alt="Français">Français</a><a--%>
                    <%--class="dropdown-item" href="account-password-recovery.html#"><img src="img/flags/DE.png"--%>
                                                                                      <%--alt="Deutsch">Deutsch</a><a--%>
                    <%--class="dropdown-item" href="account-password-recovery.html#"><img src="img/flags/IT.png"--%>
    ...
    <%--<div class="site-branding">--%>
        <%--<div class="inner">--%>
            <%--<!-- Off-Canvas Toggle (#shop-categories)--><a class="offcanvas-toggle cats-toggle"--%>
                                                           <%--href="account-password-recovery.html#shop-categories"--%>
                                                           <%--data-toggle="offcanvas"></a>--%>
            <%--<!-- Off-Canvas Toggle (#mobile-menu)--><a class="offcanvas-toggle menu-toggle"--%>
                                                       <%--href="account-password-recovery.html#mobile-menu"--%>
                                                       <%--data-toggle="offcanvas"></a>--%>
    ...
    <%--<nav class="site-menu">--%>
        <%--<ul>--%>
            ...
            <%--<li><a href="shop-grid-ls.html"><span>Shop</span></a>--%>
                ...
                <%--</ul>--%>
            <%--</li>--%>
            <%--<li class="has-megamenu"><a href="account-password-recovery.html#"><span>Mega Menu</span></a>--%>
                <%--<ul class="mega-menu">--%>
                    <%--<li><span class="mega-menu-title">Top Categories</span>--%>
                        <%--<ul class="sub-menu">--%>
                            <%--<li><a href="account-password-recovery.html#">Men's Shoes</a></li>--%>
                            <%--<li><a href="account-password-recovery.html#">Women's Shoes</a></li>--%>
                            <%--<li><a href="account-password-recovery.html#">Shirts and Tops</a></li>--%>
                            <%--<li><a href="account-password-recovery.html#">Swimwear</a></li>--%>
                            <%--<li><a href="account-password-recovery.html#">Shorts and Pants</a></li>--%>
                            <%--<li><a href="account-password-recovery.html#">Accessories</a></li>--%>
                        <%--</ul>--%>
                    <%--</li>--%>
                    <%--<li><span class="mega-menu-title">Specialty Shops</span>--%>
                        <%--<ul class="sub-menu">--%>
                            <%--<li><a href="account-password-recovery.html#">Junior's Shop</a></li>--%>
                            <%--<li><a href="account-password-recovery.html#">Swim Shop</a></li>--%>
                            <%--<li><a href="account-password-recovery.html#">Athletic Shop</a></li>--%>
                            <%--<li><a href="account-password-recovery.html#">Outdoor Shop</a></li>--%>
                            <%--<li><a href="account-password-recovery.html#">Luxury Shop</a></li>--%>
                            <%--<li><a href="account-password-recovery.html#">Accessories Shop</a></li>--%>
                        <%--</ul>--%>
                    <%--</li>--%>
                    <%--<li>--%>
                        <%--<section class="promo-box" style="background-image: url(img/banners/02.jpg);"><span--%>
                            ...
                            <%--<div class="promo-box-content text-center padding-top-2x padding-bottom-2x">--%>
                                ...
                                <%--<h3 class="text-bold text-light text-shadow">Sunglasses</h3><a--%>
                                    <%--class="btn btn-sm btn-primary" href="account-password-recovery.html#">Shop Now</a>--%>
                            <%--</div>--%>
                        <%--</section>--%>
                    <%--</li>--%>
                    <%--<li>--%>
                        <%--<section class="promo-box" style="background-image: url(img/banners/03.jpg);">--%>
                            ...
                            <%--<div class="promo-box-content text-center padding-top-2x padding-bottom-2x">--%>
                                ...
                                <%--<h4 class="text-light text-thin text-shadow">save up to 50%!</h4><a--%>
                                    <%--class="btn btn-sm btn-primary" href="account-password-recovery.html#">Learn More</a>--%>
                            <%--</div>--%>
                        <%--</section>--%>
                    <%--</li>--%>
                <%--</ul>--%>
            ...
            <%--<li><a href="blog-rs.html"><span>Blog</span></a>--%>
                ...
                <%--</ul>--%>
            <%--</li>--%>
            <%--<li><a href="account-password-recovery.html#"><span>Pages</span></a>--%>
                <%--<ul class="sub-menu">--%>
                    <%--<li><a href="about.html">About Us</a></li>--%>
                    <%--<li><a href="contacts.html">Contacts</a></li>--%>
                    <%--<li><a href="faq.html">Help / FAQ</a></li>--%>
            ...
            <%--<div class="tools">--%>
                ...
                <%--<div class="account"><a href="account-orders.html"></a><i class="icon-head"></i>--%>
                    <%--<ul class="toolbar-dropdown">--%>
                        ...
                        <%--<li><a href="account-password-recovery.html#"> <i class="icon-unlock"></i>Logout</a></li>--%>
                    <%--</ul>--%>
                <%--</div>--%>
    ...
    <div class="container padding-bottom-3x mb-2">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                ...
                <form class="card mt-4" action="/successfully" method="post">
                    <div class="card-body">
                        <div class="form-group">
                            <c:if test="${message==null}">
                                <label for="email-for-pass"> Enter your Password</label>
                            </c:if>
                            <c:if test="${message!=null}">
                                <label for="email-for-pass"> ${message}</label>
                            </c:if>
                            <input class="form-control" type="text" id="email-for-pass" name="oldPass"
                                   placeholder="OldPassword" required>
                            <small class="form-text text-muted"></small>
                            <input class="form-control" type="text" id="email-for-pass" name="passwordR"
                                   placeholder="New Rassword" required>
                            <small class="form-text text-muted"></small>
                            <input class="form-control" type="text" id="email-for-pass" name="RpasswordR"
                    ...
                    <div class="card-footer">
                        <input class="btn btn-primary" type="submit">Get New Password</input>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    ...
                    <section class="widget widget-light-skin">
                        ...
                        <p><a class="navi-link-light" href="account-password-recovery.html#">support@unishop.com</a></p>
                        <a class="social-button shape-circle sb-facebook sb-light-skin"
                           href="account-password-recovery.html#"><i class="socicon-facebook"></i></a><a
                            class="social-button shape-circle sb-twitter sb-light-skin"
                            href="account-password-recovery.html#"><i class="socicon-twitter"></i></a><a
                            class="social-button shape-circle sb-instagram sb-light-skin"
                            href="account-password-recovery.html#"><i class="socicon-instagram"></i></a><a
                            class="social-button shape-circle sb-google-plus sb-light-skin"
                            href="account-password-recovery.html#"><i class="socicon-googleplus"></i></a>
                    </section>
                </div>
                <div class="col-lg-3 col-md-6">
                    <!-- Mobile App Buttons-->
                    <section class="widget widget-light-skin">
                        <h3 class="widget-title">Our Mobile App</h3><a class="market-button apple-button mb-light-skin"
                                                                       href="account-password-recovery.html#"><span
                            class="mb-subtitle">Download on the</span><span class="mb-title">App Store</span></a><a
                            class="market-button google-button mb-light-skin"
                            href="account-password-recovery.html#"><span class="mb-subtitle">Download on the</span><span
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <section class="widget widget-links widget-light-skin">
                        ...
                        <ul>
                            <li><a href="account-password-recovery.html#">Careers</a></li>
                            <li><a href="account-password-recovery.html#">About Unishop</a></li>
                            <li><a href="account-password-recovery.html#">Our Story</a></li>
                            <li><a href="account-password-recovery.html#">Services</a></li>
                            <li><a href="account-password-recovery.html#">Our Blog</a></li>
                        </ul>
                    </section>
                </div>
                <div class="col-lg-3 col-md-6">
                    ...
                    <section class="widget widget-links widget-light-skin">
                        ...
                        <ul>
                            <li><a href="account-password-recovery.html#">Your Account</a></li>
                            <li><a href="account-password-recovery.html#">Shipping Rates & Policies</a></li>
                            <li><a href="account-password-recovery.html#">Refunds & Replacements</a></li>
                            <li><a href="account-password-recovery.html#">Taxes</a></li>
                            <li><a href="account-password-recovery.html#">Delivery Info</a></li>
                            <li><a href="account-password-recovery.html#">Affiliate Program</a></li>
                        </ul>
                    </section>
                </div>
            </div>
...
<!-- Back To Top Button--><a class="scroll-to-top-btn" href="account-password-recovery.html#"><i
