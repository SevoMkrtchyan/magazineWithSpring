        ...
        <%--<ul>--%>
            ...
            <%--<li><a href="#"><span>Shop</span></a>--%>
                <%--<ul class="sub-menu">--%>
                    ...
                    <%--&lt;%&ndash;</ul>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
                    <%--<li><a href="/shProduscts">Shop Products</a></li>--%>
...
<div class="offcanvas-wrapper">
    ...
    <div class="container padding-bottom-3x mb-2">
        <div class="row">
            ...
            <div class="col-xl-9 col-lg-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <h5><a class="navi-link" href="/sCategory?id=${category.id}">${category.name} </a></h5>
        ...
        <c:if test="${allGoodsByNameContains!=null}">
            <c:forEach items="${allGoodsByNameContains}" var="good">
                <div class="card mb-4">
                    <div class="card-header"><span class="badge badge-pill badge-primary">Product</span></div>
                    <div class="card-body">
                        <div class="d-flex"><a class="pr-4 hidden-xs-down" href="${pageContext.request.contextPath}/pSingle?pId=${good.id}"
                                               style="max-width: 225px;"><img
                                src="${pageContext.request.contextPath}/image?fileName=${good.pictures.get(0).name}"
                                alt="Product"></a>
                            <div>
                                <h5><a class="navi-link" href="${pageContext.request.contextPath}/pSingle?pId=${good.id}">${good.name} </a></h5>
                                <h6>
            ...
            <section class="widget widget-categories">
                ...
                <ul>
                    <li class="has-children expanded"><a
                        ...
                        <ul>
                            <li><a href="search-results.html#">Women's</a><span>(508)</span>
                                <ul>
                                    <li><a href="search-results.html#">Sneakers</a></li>
                                    <li><a href="search-results.html#">Heels</a></li>
                                    <li><a href="search-results.html#">Loafers</a></li>
                            ...
                            <li><a href="search-results.html#">Men's</a><span>(423)</span>
                                <ul>
                                    <li><a href="search-results.html#">Boots</a></li>
                                    <li><a href="search-results.html#">Oxfords</a></li>
                                    <li><a href="search-results.html#">Loafers</a></li>
                                    <li><a href="search-results.html#">Sandals</a></li>
                                </ul>
                            </li>
                    ...
                    <li class="has-children"><a href="search-results.html#">Accessories</a><span>(874)</span>
                        <ul>
